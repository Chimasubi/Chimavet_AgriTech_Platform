      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            <div className="bg-gradient-to-tr from-indigo-800 via-indigo-600 to-indigo-500 text-white p-2.5 rounded-2xl group-hover:scale-105 transition-all shadow-md shadow-indigo-600/20">
              <Sprout className="w-6 h-6" />
            </div>
            <div>
              <span className="text-xl sm:text-2xl font-black tracking-tight text-slate-900 font-sans block leading-none">
                Chima<span className="text-indigo-600">vet</span>
              </span>
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/shop"
              className="hidden sm:flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-xl text-xs font-bold transition-all shadow-sm shadow-indigo-600/20"
            >
