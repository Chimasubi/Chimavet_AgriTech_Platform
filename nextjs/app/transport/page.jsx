...
export default function TransportPage() {
  const { transportBookings, addTransport, removeTransport } = useCart()
      ...
      <div className="grid lg:grid-cols-5 gap-5 mb-10">
        ...
        <div className="lg:col-span-3">
          ...
          <div className="space-y-3">
            {filtered.map(d => (
              <div key={d.id} className="bg-white rounded-2xl border border-stone-200 p-4 card-lift">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-3 flex items-center justify-between">
                      ...
                      <button onClick={() => handleBook(d)} className="px-4 py-2 bg-gradient-to-r from-orange-500 to-red-500 hover:shadow-lg text-white rounded-full text-sm font-semibold flex items-center gap-1.5">
