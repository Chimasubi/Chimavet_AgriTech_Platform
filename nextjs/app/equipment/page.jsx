...
import { EQUIPMENT, TSh, EQ_CATEGORIES } from '@/lib/data'
...
export default function EquipmentPage() {
  const { rentals, addRental, removeRental } = useCart()
  ...
  const handleConfirm = (data) => {
    addRental({
      name: booking.name, loc: booking.loc, owner: booking.owner, img: booking.img,
      ...data
    })
    setBooking(null)
  }
  ...
  return (
    <>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
        {list.map(e => (
          <div key={e.id} className="group bg-white rounded-3xl overflow-hidden border border-stone-200 card-lift">
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-stone-100">
                ...
                <button onClick={() => setBooking(e)} className="px-4 py-2.5 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:shadow-lg hover:shadow-emerald-500/30 text-white rounded-full text-sm font-semibold transition flex items-center gap-1.5">
      ...
      {booking && <BookingModal item={booking} onClose={() => setBooking(null)} onConfirm={handleConfirm} />}
    </>
  )
}
