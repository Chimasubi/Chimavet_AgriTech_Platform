// Mock AI agent logic. Swap these for real API calls (OpenAI/Claude Vision, weather APIs, market data feeds) by replacing the function bodies.

export const AI_RESPONSES = {
  vaccine: "Ratiba za chanjo: Kuku wanahitaji Newcastle wiki 1, 6, 14. Ng'ombe FMD kila miezi 6. Mbuzi PPR kila mwaka. Fuata ushauri wa daktari wa mifugo!",
  irrigation: "Kwa umwagiliaji wa matone, mwagilia asubuhi mapema (5-7am) kupunguza uvukizi. Weka unyevu wa udongo 40-60%. Angalia matone kila wiki.",
  maize: "Panda mahindi mwanzoni mwa mvua. Nafasi: 75cm x 25cm. Weka NPK wakati wa kupanda, kisha urea wiki ya 4. Tarajia tani 4-6 kwa ekari.",
  chicken: "Kuku wa mayai wanaanza kutaga wiki 18-22. Mpe mwanga wa saa 16 kwa siku. Chakula 110-120g kwa kuku kwa siku. Tenga kuku wagonjwa mara moja.",
  cattle: "Ng'ombe wanahitaji maji 25-30L kwa siku. Dawa ya minyoo kila miezi 3. Chanja kila mwaka. Badilisha malisho kuzuia magonjwa.",
  goat: "Mbuzi wanapenda majani ya miti kuliko nyasi. Maji 2-4L kwa siku. Kata kwato kila wiki 6. Tenga eneo la kulisha watoto.",
  pest: "Kwa armyworm kwenye mahindi, nyunyiza asubuhi mapema na Emamectin Benzoate. Hifadhi wanyama wa porini. Mzunguko wa mazao unavunja mzunguko wa wadudu.",
  soil: "Pima pH ya udongo - mazao mengi wanapenda 6.0-7.0. Ongeza chokaa kama ni asidi, gypsum kama ni alkali. Ongeza mboji kila mwaka.",
  price: "Bei za soko zinabadilika kila wiki. Angalia soko la karibu, masoko ya mikoa, na majukwaa kama M-Kulima kwa bei bora."
};
...
const CROP_DISEASES = [
  {
    ...
    confidence: 0.87,
    affected: 'Maize',
    symptoms: ['Yellow streaks along leaf veins', 'Stunted growth', 'Leaf curling'],
    causes: 'Spread by leafhoppers (Cicadulina spp.) and infected seed.',
    treatment: [
      'Remove and burn infected plants',
      'Control leafhoppers with Imidacloprid spray',
      'Plant resistant varieties (e.g. PAN 53, DK 8031)',
      'Avoid late planting'
    ],
    severity: 'High',
    icon: '🌽'
  },
  {
    ...
    confidence: 0.92,
    affected: 'Tomato / Potato',
    symptoms: ['Dark water-soaked lesions on leaves', 'White fungal growth under leaves', 'Brown fruit rot'],
    causes: 'Phytophthora infestans fungus; thrives in cool, wet weather.',
    treatment: [
      'Spray with Mancozeb 75% WP (50g/20L water)',
      'Remove and destroy infected plants immediately',
      'Improve air circulation by pruning',
      'Apply preventive copper-based fungicides weekly'
    ],
    severity: 'Critical',
    icon: '🍅'
  },
  {
    ...
    confidence: 0.81,
    affected: 'Beans',
    symptoms: ['Reddish-brown pustules on leaf undersides', 'Yellow halos around spots', 'Premature leaf drop'],
    causes: 'Uromyces appendiculatus fungus, spread by wind and rain.',
    treatment: [
      'Spray with Sulphur 80% WP or Hexaconazole',
      'Rotate crops every 2-3 years (avoid beans)',
      'Plant resistant varieties (e.g. GLP 2, KAT B1)',
  ...
  },
  {
    ...
    confidence: 0.78,
    affected: 'Cabbage / Kale',
    symptoms: ['V-shaped yellow lesions from leaf edges', 'Black veins inside leaves', 'Wilting'],
    causes: 'Xanthomonas campestris bacteria; spread by water splash and infected seed.',
    treatment: [
      'Use certified disease-free seed',
      'Hot water treat seeds at 50°C for 30 min',
      'Spray with copper hydroxide (Kocide 101)',
  ...
  },
  {
    name: 'Fall Armyworm',
    confidence: 0.94,
    affected: 'Maize (and 80+ other crops)',
    symptoms: ['Windowpane damage on young leaves', 'Frass (droppings) in whorl', 'Damaged growing point'],
    causes: 'Spodoptera frugiperda larvae; invasive pest from Americas.',
    treatment: [
      'Apply Emamectin Benzoate 5% WG (4g/20L) into whorl',
      'Hand-pick and crush larvae in small plots',
      'Use pheromone traps to monitor moth flights',
      'Encourage natural predators (wasps, birds)'
    ],
    severity: 'Critical',
    icon: '🐛'
  },
  {
    ...
    confidence: 0.95,
    affected: 'General',
    symptoms: ['Vibrant green color', 'No visible lesions', 'Normal growth pattern'],
    causes: 'No disease detected. Plant appears healthy.',
    treatment: [
      'Continue regular watering and fertilization',
      'Monitor weekly for early signs of pests',
...
export const COMMODITIES = [
  ...
  { id: 'onion', name: 'Vitunguu (Onion)', unit: 'kg', emoji: '🧅', base: 850 },
...
export function getMarketPrices() {
  return COMMODITIES.map(c => {
    ...
    const changePct = ((current - weekAgo) / weekAgo * 100).toFixed(1)
    return { ...c, market, current, weekAgo, trend, changePct: Number(changePct), history }
  })
}
